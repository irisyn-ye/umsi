...
health = health + addl_health_resources
#print(health)
...
addl_academic_resources_1 = addl_academic_resources[0] + addl_academic_resource_numbers[0]
addl_academic_resources_2 = addl_academic_resources[-1] + addl_academic_resource_numbers[-1]
addl_academic_resources_1_ls = [addl_academic_resources_1]
addl_academic_resources = addl_academic_resources_1_ls.append(addl_academic_resources_2)
...
umich_wellness = health.index('Wolverine Wellness|734-763-1320')

student_focused_health_resources = health[umsi_caps] + health[umich_wellness]
