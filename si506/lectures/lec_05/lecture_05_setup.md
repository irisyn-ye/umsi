...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_05/
cp lecture_05_setup.md lecture_05.md lecture_05.py ../Documents/umich/courses/SI506/lectures/lecture_05/
cd ../Documents/umich/courses/SI506/lectures/lecture_05/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_05`.

3. Copy (`cp`) the downloaded files to the `lecture_05` directory.
...
4. Navigate (`cd`) to your `lecture_05` directory.

5. Confirm "that the contents of the `lecture_05` directory are as expected (i.e., it contains
...
1. Hover over `lecture_05.md`, right-click, and select "Open Preview".
2. Hover over `lecture_05.py`, right-click, and select "Open to the Side".
