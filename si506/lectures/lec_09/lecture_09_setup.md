...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_09/
cp lecture_09.md lecture_09.py loops.drawio ../Documents/umich/courses/SI506/lectures/lecture_09/
cd ../Documents/umich/courses/SI506/lectures/lecture_09/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_09`.

3. Copy (`cp`) the downloaded files to the `lecture_09` directory.
...
4. Navigate (`cd`) to your `lecture_09` directory.

5. Confirm "that the contents of the `lecture_09` directory are as expected (i.e., it contains
...
1. Hover over `lecture_09.md`, right-click, and select "Open Preview".
2. Hover over `lecture_09.py`, right-click, and select "Open to the Side".
