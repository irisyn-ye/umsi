...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_08/
cp lecture_08.md lecture_08.py ../Documents/umich/courses/SI506/lectures/lecture_08/
cd ../Documents/umich/courses/SI506/lectures/lecture_08/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_08`.

3. Copy (`cp`) the downloaded files to the `lecture_08` directory.
...
4. Navigate (`cd`) to your `lecture_08` directory.

5. Confirm "that the contents of the `lecture_08` directory are as expected (i.e., it contains
...
1. Hover over `lecture_08.md`, right-click, and select "Open Preview".
2. Hover over `lecture_08.py`, right-click, and select "Open to the Side".
