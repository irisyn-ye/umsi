...
``` commandline
cd ~/Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_03/
cp lecture_03.md lecture_03.py python_objects.png ../Documents/umich/courses/SI506/lectures/lecture_03/
cd ../Documents/umich/courses/SI506/lectures/lecture_03/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_03`.

3. Copy (`cp`) the downloaded files to the `lecture_03` directory.
...
4. Navigate (`cd`) to your `lecture_03` directory.

5. Confirm "that the contents of the `lecture_03` directory are as expected (i.e., it contains
...
1. Hover over `lecture_03.md`, right-click, and select "Open Preview".
2. Hover over `lecture_03.py`, right-click, and select "Open to the Side".
