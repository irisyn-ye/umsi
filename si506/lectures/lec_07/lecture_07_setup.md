...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_07/
cp lecture_07_setup.md lecture_07.md lecture_07.py ../Documents/umich/courses/SI506/lectures/lecture_07/
cd ../Documents/umich/courses/SI506/lectures/lecture_07/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_07`.

3. Copy (`cp`) the downloaded files to the `lecture_07` directory.
...
4. Navigate (`cd`) to your `lecture_07` directory.

5. Confirm "that the contents of the `lecture_07` directory are as expected (i.e., it contains
...
1. Hover over `lecture_07.md`, right-click, and select "Open Preview".
2. Hover over `lecture_07.py`, right-click, and select "Open to the Side".
